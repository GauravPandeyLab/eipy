...
class EnsembleIntegration:
    ...
    additional_ensemble_methods : list of str, default=['Mean', 'CES']
        Additional ensemble methods to be used. Can include 'Mean', 'Median' and 'CES'.
        The 'CES' ensemble method is described in Caruana R. et al. (2006) Getting
        the most out of ensemble selection. In: Sixth International Conference on Data
    ...
    def __init__(
        ...
        additional_ensemble_methods=None,
        ...
        if meta_predictors is not None:
            ...
            self.meta_predictors = {"S." + k: v for k, v in meta_predictors.items()}
    ...
    def train_meta(self, meta_predictors=None):
        """
        Train ensemble methods on data generated by train_base. Ensembles considered
        are the union of meta_predictors and additional_ensemble_methods.
        ...
        meta_model_key :
            ...
            prefix 'S.'. E.g. for the user defined base predictor key 'LR',
            the meta_model_key will be 'S.LR'.
        ...
        if self.additional_ensemble_methods is not None:
            self.meta_predictors = {
                **self.additional_ensemble_methods,
                **self.meta_predictors,
            }
